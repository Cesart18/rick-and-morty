...
/// {@template searched_body}
/// Body for search results.
/// {@endtemplate}
class _SearchedBody extends StatefulWidget {
  /// {@macro searched_body}
  const _SearchedBody();

  @override
  State<_SearchedBody> createState() => _SearchedBodyState();
}

class _SearchedBodyState extends State<_SearchedBody> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(
            child:
                BlocBuilder<SearchedCharacteresBloc, SearchedCharacteresState>(
